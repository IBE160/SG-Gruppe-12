...
**Document:** `C:\Users\kayle\Desktop\SG-Gruppe-12\docs\sprint-artifacts\2-7-autosave-unsaved-changes-warning.context.xml`
...
Evidence: The `<docs>` element contains 5 relevant artifact entries from the PRD, tech spec, and UX spec.

[✓] Relevant code references included with reason and line hints
Evidence: The `<code>` element correctly identifies the custom hooks and state management files to be created or modified.

[✓] Interfaces/API contracts extracted if applicable
Evidence: The `<interfaces>` element correctly states that no new endpoints are required for this story.

[✓] Constraints include applicable dev rules and patterns
Evidence: The `<constraints>` element highlights the critical performance and UX constraints regarding debouncing and the `beforeunload` event.
...
Evidence: The `<tests>` element is fully populated with standards, locations, and specific test ideas for the autosave functionality.
